...
header.innerHTML =
    "<h1>JavaScript Made This!!</h1> <h3><span id='name'>Cameron</span> shamefully wrote the JavaScript</h3>";
...
messageLeft[0].textContent =
    "Hi there my name is Janessaleigh, would you like to hear about Young Living Essential Oils?";
messageRight[0].textContent = "uh hi yes I'm good thanks.";
messageLeft[1].textContent =
    "Oh I insist, they're so effective I don't vaccinate my children anymore. Just apply that eucalyptus. :D";
...
function themeChange() {
    if (dropDown.value === "theme-one") {
        ...
        const arr = [...messageLeft].map(message => console.log(message));
